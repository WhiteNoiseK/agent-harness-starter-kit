...
/harness-verify {{TASK_ID_EXAMPLE}} "{{TESTS_ROOT}}/unit/test_<module>.py" "pkg.subpkg"
...
- `.claude/commands/harness-verify.md` — Stage 3–6 chaining slash command (single source for the stage→agent mapping)
...
User invokes:
  ...
  3. /harness-verify <task_id> <test_paths> <dotted.module>
